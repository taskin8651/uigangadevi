...
<div class="admin-page-head">
    <div>
        ...
        <p class="admin-page-subtitle">
            Update academic course details and assigned subjects
        </p>
    </div>
</div>
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    @else
                        <p class="field-hint">
                            <i class="fas fa-info-circle"></i>
                            Upload a new image only when replacing the current image.
                        </p>
                    @endif
                </div>

                @if($course->image)
                    <div class="course-image-preview current-image-box"
                         id="currentCourseImage">
                        ...
                        <label class="remove-image-option">
                            <input type="checkbox"
                                   name="remove_course_image"
                                   value="1"
                                   id="remove_course_image"
                                   {{ old('remove_course_image') ? 'checked' : '' }}>
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <textarea name="short_description"
                              ...
                              class="field-input {{ $errors->has('short_description') ? 'error' : '' }}">{{ old('short_description', $course->short_description) }}</textarea>
                    ...
                    @else
                        <p class="field-hint">
                            This content appears on the frontend course card.
                        </p>
                    @endif
                </div>
            ...
            <div class="form-card-header between">
                ...
                <div class="form-card-head-left">
                    ...
                    <div>
                        ...
                        <p class="form-card-subtitle">
                            Update subjects available in this course
                        </p>
                    </div>
                </div>
            ...
            <div class="form-card-body">
                ...
                @php
                    $selectedSubjects = old(
                        'subjects',
                        $course->subjects->pluck('id')->toArray()
                    );

                    $selectedSubjects = array_map(
                        'intval',
                        $selectedSubjects
                    );
                @endphp
                ...
                <div class="checkbox-grid">
                    ...
                    @forelse($subjects as $id => $subject)
                        ...
                        <label class="subject-checkbox-item {{ $isSelected ? 'checked' : '' }}">
                ...
                <div class="form-info-box">
                    <p>
                        <i class="fas fa-info-circle"></i>
                        Selected subjects will appear on the course detail page.
                    </p>
                </div>
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <textarea name="eligibility"
                              id="eligibility"
                              class="field-input {{ $errors->has('eligibility') ? 'error' : '' }}">{{ old('eligibility', $course->eligibility) }}</textarea>
                ...
                <div class="field-group">
                    ...
                    <textarea name="admission_process"
                              ...
                              class="field-input {{ $errors->has('admission_process') ? 'error' : '' }}">{{ old('admission_process', $course->admission_process) }}</textarea>
        ...
        <div class="form-card course-full-card">
            <div class="form-card-header between">
                ...
                <div class="form-card-head-left">
                    ...
                    <div>
                        ...
                        <p class="form-card-subtitle">
                            Update important programme features
                        </p>
                    </div>
                </div>
            ...
            <div class="form-card-body">
                            ...
                            <div class="course-highlight-row">
                                ...
                                <div class="field-group mb-0">
                                    ...
                                    <div class="input-icon-wrap">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ is_array($highlight) ? ($highlight['text'] ?? '') : $highlight }}"
                                ...
                                <label class="highlight-status">
                                    <input type="checkbox"
                                           ...
                                           value="1"
                                           {{ is_array($highlight) ? (!empty($highlight['status']) ? 'checked' : '') : 'checked' }}>
                ...
                <div class="form-info-box">
                    <p>
                        <i class="fas fa-info-circle"></i>
                        Active highlights appear on the course card and details page.
                    </p>
                </div>
