...
<div class="admin-page-head">
    <div>
        ...
        <p class="admin-page-subtitle">
            Fill in the details to create a new academic subject or department
        </p>
    </div>
</div>
            ...
            <div class="form-card-header between">
                <div class="form-card-head-left">
                    ...
                    <div>
                        ...
                        <p class="form-card-subtitle">
                            Select programmes offering this subject
                        </p>
                    </div>
                </div>
                ...
                <div class="checkbox-grid">
                    ...
                    @empty
                        <div class="subject-empty-box">
                            <i class="fas fa-info-circle"></i>
                            No active courses are available. Create courses first.
                        </div>
                    @endforelse
